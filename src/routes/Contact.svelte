    ...
    <div class="container px-4 px-lg-5" data-aos="fade-up" data-aos-delay="100">
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-lg-8 col-xl-6 text-center">
                ...
                <hr class="divider">
                <p class="text-muted mb-5"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Illo adipisci debitis placeat voluptates mollitia asperiores rem ea nobis, quas sequi? </p>
            </div>
        </div>
            ...
            <div class="col-lg-6">
                ...
                <form id="contactForm" on:submit={submit} >
                    ...
                    <div class="form-floating mb-3"  data-aos="fade-up" data-aos-delay="300" >
                        <input class="form-control" id="name" required type="text" placeholder="Enter your name..." data-sb-validations="required" data-sb-can-submit="no">
                        <label for="name">Full name</label>
                        <div class="invalid-feedback" data-sb-feedback="name:required">A name is required.</div>
                    </div>
                    <!-- Email address input-->
                    <div class="form-floating mb-3"  data-aos="fade-up" data-aos-delay="400">
                        <input class="form-control" id="email" required type="email" placeholder="name@example.com" data-sb-validations="required,email" data-sb-can-submit="no">
                    ...
                    <!-- Submit Button-->
                    <div class="d-grid"  data-aos="fade-up" data-aos-delay="700"><button class="btn btn-primary rounded-pill btn-lg" id="submitButton" type="submit">Submit</button></div>
                </form>
            </div>
        </div>
